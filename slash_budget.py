...
KEEP_SLASH = frozenset({
    ...
    'апелляция',
    'update',
    # /proof вернули (заказ владельца 2026-09-04: «у нас нет такой команды» —
    # а это единственный способ приложить демку файлом прямо из Discord):
    # загрузить скрин/видео наказания без веб-панели. Видна только тем,
    # у кого право manage_messages — в меню участников не попадает.
    'proof',
