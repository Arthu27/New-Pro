...
KEEP_SLASH = frozenset({
    ...
    # мод-панель (внутри варн/мут/бан/клир — выпадающим меню) и /update
    # (только владелец бота; гильдовая, видна лишь админам — 2026-09-08).
    # /апелляция убрана (владелец 2026-09-08: «она у нас в кнопке»).
    ...
    'event-panel',
    # Мафия: группа /mafia (start/status/panel/resend/add/cancel/presets).
    'mafia',
