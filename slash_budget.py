...
KEEP_SLASH = frozenset({
    ...
    # AFK
    'afk', 'afk-remove',
    # Музыка (переведена с префикса на слеш — заказ 2026-08-27: команд мало,
    # все живут в «/», префиксных у бота больше нет)
    'play', 'pause', 'resume', 'skip', 'queue', 'nowplaying', 'leave',
