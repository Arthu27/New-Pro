...
class SLACog(commands.Cog):
    ...
    @app_commands.command(name='sla-info', description='SLA bilgilerini görüntüle')
    ...
    async def sla_info(self, interaction: discord.Interaction, policy_id: str = None):
        ...
        if policy_id:
            ...
            embed = discord.Embed(
                title=" SLA Policies",
                description=f"Toplam {len(policies)} SLA policy",
                color=discord.Color.blue(),
                timestamp=datetime.now()
            )
    ...
    @app_commands.command(name='sla-breaches', description='SLA ihlallerini görüntüle')
    async def sla_breaches(self, interaction: discord.Interaction):
        """SLA ihlallerini görüntüle"""
        # İhlaller al
        ...
        embed = discord.Embed(
            title=" SLA Breaches",
            description=f"Toplam {len(breaches)} ihlal",
    ...
    @app_commands.describe(name='Policy adı', description='Policy açıklaması')
