...
class EconomyCog (commands .Cog ):
    ...
    async def balance (self ,ctx ,member :discord .Member =None ):
        ...
        # ── daily ────────────────────────────────────────────────────────────
    @commands .command (name ='daily',aliases =['gюnlюk'])
    async def daily (self ,ctx ):
        ...
        # ── work ─────────────────────────────────────────────────────────────
    @commands .command (name ='work',aliases =['чalыш'])
...
class EconomyView (discord .ui .View ):
    ...
    @commands .command (name ='shop',aliases =['maгaza','магазин'])
    ...
    @commands .command (name ='buy',aliases =['satыnal'])
