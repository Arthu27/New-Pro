...
class Fun(commands.Cog):
    ...
    async def eglen(self, interaction: discord.Interaction, islem: str,
        ...
        if islem == "zar":
            ...
            if score >= 80:
                ...
                color, badge, yorum = 0xF39C12, " ORTA ŞANS", "Dikkatli ol, ama umudu kesme."
            else:
                color, badge, yorum = 0xE74C3C, " НИЗКИЙ ŞANS", "Сегодня temkinli ol!"
    ...
    async def profil_karti(self, interaction: discord.Interaction, user: discord.Member = None):
        ...
        e.add_field(name=" Platform", value=f"```{'Mobil' if u.is_on_mobile() else 'Masaüstü'}```", inline=True)
