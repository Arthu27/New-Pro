...
def mod_dm_embed(action, guild, moderator, reason=None, extra_fields=None, gif_key=None):
    ...
    configs = {
        "ban": {
            ...
            "note": "Считаете наказание несправедливым? Подайте апелляцию в личные сообщения бота командой /апелляция — после подачи вам откроется канал апелляции, где модерация рассмотрит её.",
            "gif": None,
        },
        "kick": {
            "title": "👢 Вы кикнуты",
