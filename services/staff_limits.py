...
#   • мут/таймаут — модеры 3/день (заказ 2026-09-24), кураторы/админы 10
...
DEFAULT_LIMITS = {
    # ── наказания ──
    'warn': 3,       # предупреждений — 3/день у модеров
    'mute': 3,       # мутов (таймаут/чат/войс) — 3/день у модеров
...
# Мод: мут 3/день (заказ 2026-09-24). Master = мод +2 (кроме варна и чистки);
# размут у мастера = мут.
TIER_DEFAULT_LIMITS = {
    # тир владельца (owner) — ВСЁ без лимитов
    'mod':     {'warn': 3, 'ban': 1, 'unmute': 3, 'mute': 3, 'clear': 10},
    'master':  {'warn': 3, 'ban': 3, 'unmute': 5, 'mute': 5, 'clear': 10},
