...
ROUTE_SPECS = [
    {
        ...
        'step': 1,
        'required': True,
        'create_hint': 'Отдельная комната для человека после бана (апелляции). Заявки в команду идут в свой канал.',
        'what': 'Комната апелляции после бана (владелец 2026-09-06): '
                'карточки апелляций с кнопками. Забаненный видит её ПОСЛЕ '
                'подачи апелляции — в момент бана она закрыта. Заявки в '
                'команду идут в отдельный канал заявок.',
        'empty': 'Не задан — при «бане» из /modpanel бот попросит выбрать канал. На боевом сервере комната уже есть.',
    },
    {
        'key': 'staff_menu_channel',
        'label': 'Канал меню набора',
        'icon': 'fa-user-plus',
        'kind': 'native',
        'access': 'Админ',
        'step': None,
    ...
    },
    {
        ...
        'what': 'Сюда падают заявки в команду (заменяет APPLY_CHANNEL_ID из .env). '
                f'По умолчанию — {STAFF_APPLY_CHANNEL_ID}. '
                'Если ниже не заданы отдельные ветки — все должности идут сюда.',
        'empty': f'Не задан — заявки идут в канал по умолчанию ({STAFF_APPLY_CHANNEL_ID}).',
    },
    # ── Дополнительное (трогать не нужно — работает по умолчанию) ──
    {
        'key': 'appeal_menu_channel',
        'label': 'Канал меню апелляций (устарело)',
        'icon': 'fa-scale-balanced',
        'kind': 'native',
        'access': 'Админ',
        'step': None,
        'required': False,
        'create_hint': 'Публичное меню отключено: апелляцию подают кнопкой в ЛС после бана.',
        'what': 'Раньше здесь было постоянное меню «Подать апелляцию». Сейчас '
                'подача только в ЛС; канал карточек — «Комната апелляции» / '
                'ban_appeal_channel. Это поле оставлено для очистки старых сообщений.',
        'empty': 'Не задан — бот чистит меню по комнате апелляции при старте.',
    },
    {
    ...
    },
    {
        ...
        'step': None,
        'required': False,
        'create_hint': 'Запасная ветка: используется, только если общего канала заявок нет.',
        'what': 'Заявки в команду идут в общий канал заявок. Эта ветка — '
                'запасная: общий канал убрали — заявки хелперов падают сюда.',
        'empty': 'Не задан — заявки идут в общий канал заявок.',
    },
    {
        ...
        'step': None,
        'required': False,
        'create_hint': 'Своя ветка модераторов — куратор × Отвечаю за Moderator.',
        'what': 'Заявки на Модератора. Если пусто — общий канал заявок.',
        'empty': 'Не задан — заявки идут в общий канал заявок.',
    },
    {
        'key': 'staff_event_channel',
        'label': 'Ветка заявок Event (отдельно)',
        'icon': 'fa-calendar-star',
        'kind': 'staff_apply',
        'access': 'Админ',
        'step': None,
        'required': False,
        'create_hint': 'Своя ветка Event — куратор × Отвечаю за Eventsmod.',
        'what': 'Заявки на Event / Eventsmod. Если пусто — общий канал заявок.',
        'empty': 'Не задан — заявки идут в общий канал заявок.',
    },
    {
        'key': 'staff_broadcaster_channel',
        'label': 'Ветка заявок Broadcaster (отдельно)',
        'icon': 'fa-tower-broadcast',
        'kind': 'staff_apply',
        'access': 'Админ',
        'step': None,
        'required': False,
        'create_hint': 'Своя ветка Broadcaster — куратор × Отвечаю за Broadcaster.',
        'what': 'Заявки на Broadcaster. Если пусто — общий канал заявок.',
        'empty': 'Не задан — заявки идут в общий канал заявок.',
    },
]
