...
# Канал доказательств / демок к наказаниям (владелец 2026-09-22).
...
ROUTE_SPECS = [
    ...
    },
    {
        ...
        'step': 3,
        'required': False,
        'create_hint': 'На боевом сервере уже есть канал доказательств '
                       '(1552088029047423027). Можно указать другой.',
        'what': 'Сюда падают «демки» к наказаниям (/modpanel, панель «Пользователи» '
                'и «Доказательства»): кто выдал, кому, за что — и фото/видео '
                'прямо в сообщении.',
        'empty': 'Не задан — на боевом сервере используется канал '
                 '1552088029047423027; иначе бот создаст #📸・доказательства.',
    },
    {
        'key': 'appeals_channel',
