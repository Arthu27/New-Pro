...
ROUTE_SPECS = [
    ...
    },
    {
        ...
        'what': 'Заявки на Модератора. Если пусто — комната заявок / общий канал.',
        'empty': 'Не задан — заявки идут в комнату заявок.',
    },
    {
        ...
        'what': 'Заявки на Event / Eventsmod. Если пусто — комната заявок.',
        'empty': 'Не задан — заявки идут в комнату заявок.',
    },
    {
        ...
        'what': 'Заявки на Broadcaster. Если пусто — комната заявок.',
        'empty': 'Не задан — заявки идут в комнату заявок.',
    },
]
