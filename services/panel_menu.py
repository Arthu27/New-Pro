...
MENU = [
    ...
    {'group': 'Настройки', 'key': 'settings', 'icon': 'fa-sliders', 'pages': [
        ...
        {'path': '/channel-settings', 'label': 'Каналы и маршруты', 'icon': 'fa-route',
         'min_role': 'owner', 'description': 'Куда бот пишет: только владелец'},
...
# «Доступ» (панель-роли и права команд) — единственное место, где владелец
# управляет правами: случайно скрыв его глазиком в «Порядке и скрытии»,
# он терял управление ролями и командами (жалоба 2026-09-05: «Права команд
# не видно»). _apply_layout игнорирует такие записи в файле — пункт
# возвращается сам, даже если в data/panel_menu.json он уже «скрыт».
_PROTECTED = ('/panel-menu', '/panel-access', '/role-permissions')
