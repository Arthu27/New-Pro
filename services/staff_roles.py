...
# Роль «× Master» (владелец 2026-09-24): тир между модером и куратором.
# Наказывать можно только вместе с Helper или Moderator — ветки
# Eventsmod/Broadcaster без этих ролей применять наказания не могут.
