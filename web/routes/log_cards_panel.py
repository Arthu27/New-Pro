...
PREVIEW_BY_CAT = {
    ...
    'invite': (('Код', 'discord.gg/hakumo'), ('Создал', 'GhostBlade'),
               ('Канал', '#правила')),
    'ban': (('Пользователь', 'GhostBlade'), ('Модератор', 'Sonya'),
            ('Причина', 'Повторные нарушения')),
    'mute': (('Пользователь', 'GhostBlade'), ('Модератор', 'Sonya'),
             ('Срок', '60 мин · чат')),
    'warn': (('Пользователь', 'GhostBlade'), ('Модератор', 'Sonya'),
             ('Варн', '#2 · всего 2')),
    'staff': (('Участник', 'GhostBlade'), ('Действие', 'снята роль модератора'),
              ('Кто', 'Sonya')),
    'rest': (('Канал', '#флудилка'), ('Действие', 'создан'),
             ('Тип', 'текстовый')),
}
