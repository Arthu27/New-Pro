...
мутации делают те же операции, что и базовые команды бота: pause/resume/stop
голосового клиента, чистые shuffle_queue/remove_track из cogs.music_cog,
очистка очереди — тем же присвоением, что и !leave.
(!shuffle/!loop/!volume/!clearqueue удалены как команды бота по решению
владельца; панельный пульт показывает только базу.)
