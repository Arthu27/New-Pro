...
- Загрузка демок файлами — на веб-панели, вкладка «Доказательства»
...
- /report @участник причина [ссылка-доказательство] — жалоба: создаётся
...
- /report-setup #канал @роль — привязать канал репортов и роль модератора (админ)
