"""
Ortak performans yardimcisi.
- atomic_write_json: gecici dosya + os.replace ile atomik yazma (yaris durumu yok, indent yok).
...
class PeriodicFlush:
    """append() hizli, gercek dosya yazimini arka planda toplu yapar."""
