...
# 5б-3. макет сообщения «как в Discord»: владелец видит не только картинку,
# но и ВСЁ, что будет написано в карточке (жалоба 2026-09-05: «что писать
...
check('id="apLookPvImgWrap"' in atpl and 'imgWrap.style.display' in atpl,
      'макет: картинка внутри эмбеда; без картинки остаются тексты и кнопки')
