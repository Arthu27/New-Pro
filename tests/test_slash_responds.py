...
check('multi-fix-v14' in mp or 'multi-fix-v13' in mp or 'build=multi-fix' in mp,
...
check('multi-fix-v14' in mod_src or 'multi-fix-v13' in mod_src,
...
check('_schedule_panel_reset' not in tgt_body,
      'после участника НЕТ фонового rebuild (гонка ломала Действие)')
