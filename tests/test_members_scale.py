...
r = page(0, limit=99999)
check(r.headers.get('X-Limit') == '5000',
      f"потолок пачки={r.headers.get('X-Limit')} (запросили 99999)")
check(len(r.get_json()) == 5000, 'по потолку приходит 5000 человек')
