...
print('\n== IDLE-WAIT / RECONNECT-WAIT классификация ==')
import error_handler as eh2
...
_reconn = (
    '  File "discord\\gateway.py", line 557, in received_message\n'
    '    self._keep_alive.start()\n'
    '  File "threading.py", line 1011, in start\n'
    '    self._started.wait()\n'
)
check(eh2.is_reconnect_wait_stack(_reconn) is True,
      'gateway KeepAliveHandler.start → RECONNECT-WAIT')
check(eh2.is_idle_wait_stack(_reconn) is False,
      'reconnect-стек не путаем с IDLE-WAIT')
