...
print('== claimed_underage (1–13 удаляем, 14+ нет) ==')
...
# 13 тоже удаляем
check(claimed_underage('мне 13') == 13, 'мне 13 → 13')
check(claimed_underage('мне 13 лет') == 13, 'мне 13 лет → 13')
check(claimed_underage('13 лет') == 13, '13 лет → 13')
check(claimed_underage('13') == 13, 'голое 13 → 13')
...
check(claimed_underage('15 лет') is None, '15 лет → None')
check(claimed_underage('14 лет') is None, '14 лет → None')

# обходы символами (в т.ч. 13)
check(claimed_underage('мне +12') == 12, 'мне +12 → 12')
...
check(claimed_underage('+13 лет') == 13, '+13 лет → 13')
check(claimed_underage('мне 13+') == 13, 'мне 13+ → 13')
check(claimed_underage('мне 13_') == 13, 'мне 13_ → 13')
check(claimed_underage('13_') == 13, '13_ → 13')
check(claimed_underage('13+') == 13, '13+ → 13')
check(claimed_underage('+13') == 13, '+13 → 13')
check(claimed_underage('мне 1 3') == 13, 'мне 1 3 → 13')
check(claimed_underage('2013') is None, '2013 → None')
