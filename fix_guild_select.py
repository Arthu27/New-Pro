...
# Pattern: async function loadGuilds() { ... } bloгunu найти ve изменить
...
for fname in os.listdir(TEMPLATES_DIR):
    ...
    # loadGuilds fonksiyonunu найти ve изменить (только geri загрузить API чaгrыsы yapanlarы)
    ...
    # Сервер выбор dropdown'larыnы gizle (display:none add)
